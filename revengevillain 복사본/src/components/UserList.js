  ...
  <Container>
    ...
    <Grid>
      ...
      <Box className="searchFeild">
        <TextField className="searchNickname" id="filled-basic" label="닉네임 입력하세요" variant="filled" />
        <TextField className="searchUrl" id="filled-basic" label="steam url을 입력하세요" variant="filled" />
      </Box>
      )}
    </Grid>

                    ...
                    <TableBody>
                        {datas.map((item) => (
                            <TableRow key={item.id} sx={{ '&:last-child td, &:last-child th': { border: 0 }}}>
                                ...
                                {isUpdate===item.id?(
                                    // <TableCell align="center"><input type="text" value={item.title} /></TableCell>
                                ...
                                {/* <TableCell align="center"><Button variant="outlined" color="primary" size="small" onClick={()=>onUpdate()}>Submit</Button></TableCell> */}
                                <TableCell align="center"><Button variant="outlined" color="primary" size="small" onClick={()=>setIsUpdate(item.id)}>Update</Button></TableCell>
